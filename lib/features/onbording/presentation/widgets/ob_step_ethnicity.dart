...
class _ObStepEthnicityState extends ConsumerState<ObStepEthnicity> {
  ...
  Widget build(BuildContext context) {
    ...
    final ethnicitiesAsync = ref.watch(ethnicitiesProvider);
                      ...
                      child: Padding(
                        ...
                        child: Column(
                          children: [
                            ...
                            ElevatedButton(
                              onPressed: () => ref.invalidate(ethnicitiesProvider),
                          ...
                          return GestureDetector(
                            ...
                            child: AnimatedContainer(
                              ...
                              decoration: BoxDecoration(
                                ...
                                color: isSelected
                                    ? getColorFromHint(ethnicity.colorHint).withOpacity(0.6)
                                    : Colors.white,
                                border: Border.all(
                                  color: isSelected
